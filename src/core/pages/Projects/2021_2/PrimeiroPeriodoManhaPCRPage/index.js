...
import { PrimeiroPeriodoManhaPCR } from '../../listProjects/2021_2/PrimeiroPeriodoManhaPCR'
// IMPORT LIST

function PrimeiroPeriodoManhaPCRPage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {PrimeiroPeriodoManhaPCR.map((array, index) => {
                                return (
...
export default PrimeiroPeriodoManhaPCRPage;