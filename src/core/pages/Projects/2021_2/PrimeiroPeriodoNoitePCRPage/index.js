...
import {PrimeiroPeriodoNoitePCR} from '../../listProjects/2021_2/PrimeiroPeriodoNoitePCR'
// IMPORT LIST

function PrimeiroPeriodoNoitePCRPage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {PrimeiroPeriodoNoitePCR.map((array, index) => {
                                return (
...
export default PrimeiroPeriodoNoitePCRPage;