...
import { QuartoPeriodoManha } from '../../listProjects/2021_2/QuartoPeriodoManha'
// IMPORT LIST

function QuartoPeriodoManhaPage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {QuartoPeriodoManha.map((array, index) => {
                                return (
...
export default QuartoPeriodoManhaPage;