...
import {QuartoPeriodoManhaPD} from '../../listProjects/2021_2/QuartoPeriodoManhaPD'
// IMPORT LIST

function QuartoPeriodoManhaPDPage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {QuartoPeriodoManhaPD.map((array, index) => {
                                return (
...
export default QuartoPeriodoManhaPDPage;