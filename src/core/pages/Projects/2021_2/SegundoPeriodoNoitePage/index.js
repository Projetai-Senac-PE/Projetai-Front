...
import { SegundoPeriodoNoite } from '../../listProjects/2021_2/SegundoPeriodoNoite'
// IMPORT LIST

function SegundoPeriodoNoitePage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {SegundoPeriodoNoite.map((array, index) => {
                                return (
...
export default SegundoPeriodoNoitePage;