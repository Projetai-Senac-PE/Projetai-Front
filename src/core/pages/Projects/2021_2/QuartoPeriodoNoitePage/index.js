...
import {QuartoPeriodoNoite} from '../../listProjects/2021_2/QuartoPeriodoNoite'
// IMPORT LIST

function QuartoPeriodoNoitePage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {QuartoPeriodoNoite.map((array, index) => {
                                return (
...
export default QuartoPeriodoNoitePage;