...
import { SegundoPeriodoManhaPD } from '../../listProjects/2021_2/SegundoPeriodoManhaPD'
// IMPORT LIST

function SegundoPeriodoManhaPDPage() {
            ...
            <Row className="m-0 p-0">
                ...
                <Col xl="10" >
                    ...
                    <div className="container">
                        <Row>
                            {SegundoPeriodoManhaPD.map((array, index) => {
                                return (
...
export default SegundoPeriodoManhaPDPage;